...
/* :code-block-start:twc1
   :hide-start: */
    ...
    // :replace-with:
    // //TODO: declare member variables at the top of the new class
    // :hide-end:
    //:code-block-end:

/* :code-block-start:twc2
   :hide-start: */
...
/* :replace-with:
    // TODO:  Initialize these values with a new init() method:
    required init(realm: Realm, title: String) {
        ...
    }
:hide-end:
